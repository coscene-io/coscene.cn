      ...
      primarySlot={
        <div className="lg:pr-32 xl:pr-48">
          ...
          <p className="mt-8 text-xl font-light leading-relaxed">
            The autonomous driving industry is technically demanding, with many segments and complex
            scenarios, requiring large amounts of data and efficient operation to support the
            long-tail development process.
          </p>
        </div>
      }
    ...
    <SplitSection
      ...
      primarySlot={
        <div className="lg:pl-32 xl:pl-48">
          ...
          <p className="mt-8 text-xl font-light leading-relaxed">
            The Industrial Internet of Things (IIoT) integrates machines, cloud computing,
            analytics, and human resources to improve the performance and productivity of industrial
            processes. The massive amount of data generated by billions of interconnected devices is
            the real treasure that will drive efficient production in the next era. How to
            effectively use such data becomes the key to success.
          </p>
        </div>
      }
